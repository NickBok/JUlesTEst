  ...
  extend(WebAudioRecorder.prototype, {
      ...
      if (this.isRecording())
        ...
        if (!scriptprocessor) {
          if (!this.recordWorkletProcessor) {
            globalAudioContext.audioWorklet.addModule('lib/audio/record-worklet-processor.js').then(()=>{
    ...
    finishRecording: function() {
      if (this.isRecording()) {
        ...
        console.log("WebAudioRecorder.min.js: finishRecording called when not recording. this.processor:", this.processor, "this.worker:", this.worker, "this.startTime:", this.startTime);
