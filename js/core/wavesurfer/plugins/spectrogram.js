...
class SpectrogramPlugin extends base_plugin_js_1.default {
    frequenciesDataUrl;
    container;
    wrapper;
    labelsEl;
    ...
    drawSpectrogram(frequenciesData) {
        ...
        for (let c = 0; c < frequenciesData.length; c++) {
            ...
            createImageBitmap(imageData, 0, Math.round(bitmapHeight * (1 - rMax1)), width, Math.round(bitmapHeight * (rMax1 - rMin))).then((bitmap) => {
