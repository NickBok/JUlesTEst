!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : ((t = "undefined" != typeof globalThis ? globalThis : t || self).WaveSurfer = t.WaveSurfer || {}, t.WaveSurfer.Regions = e())
}(this, (function () {
    "use strict";
    ...
    function i(t, e, i, n, s = 3, r = 0, o = 100) {
        ...
        const l = l => {
            ...
            const v = Date.now(), g = n => {
                if (n.preventDefault(), n.stopPropagation(), a && Date.now() - v < o) return;
                const r = n.clientX, h = n.clientY, l = r - d, g = h - c;
                if (u || Math.abs(l) > s || Math.abs(g) > s) {
                    const n = t.getBoundingClientRect(), {left: s, top: o} = n;
                    u || (null == i || i(d - s, c - o), u = !0), e(l, g, r - s, h - o), d = r, c = h
                }
            }, p = e => {
                if (u) {
                ...
                t.relatedTarget && t.relatedTarget !== document.documentElement || p(t)
            }, f = t => {
                u && (t.stopPropagation(), t.preventDefault())
            }, b = t => {
                u && t.preventDefault()
            };
            document.addEventListener("pointermove", g), document.addEventListener("pointerup", p), document.addEventListener("pointerout", m), document.addEventListener("pointercancel", m), document.addEventListener("touchmove", b, {passive: !1}), document.addEventListener("click", f, {capture: !0}), h = () => {
    ...
    function n(t, e) {
        ...
        for (const [t, s] of Object.entries(e)) if ("children" === t) for (const [t, s] of Object.entries(e)) "string" == typeof s ? i.appendChild(document.createTextNode(s)) : i.appendChild(n(t, s)); else "style" === t ? Object.assign(i.style, s) : "textContent" === t ? i.textContent = s : i.setAttribute(t, s.toString());
        return i
    }
    ...
    class r extends t {
        ...
        _onUpdate(t, e) {
            ...
            const {width: i} = this.element.parentElement.getBoundingClientRect(), n = t / i * this.totalDuration,
                s = e && "start" !== e ? this.start : this.start + n, r = e && "end" !== e ? this.end : this.end + n,
                o = r - s;
            s >= 0 && r <= this.totalDuration && s <= r && o >= this.minLength && o <= this.maxLength && (this.start = s, this.end = r, this.renderPosition(), this.emit("update", e))
        }
        ...
        setContent(t) {
            ...
            if (null === (e = this.content) || void 0 === e || e.remove(), t) {
                if ("string" == typeof t) {
                    ...
                    this.content = s("div", {
                        style: {padding: `0.2em ${e ? .2 : .4}em`, display: "inline-block"},
                        textContent: t
                    })
                } else this.content = t;
        ...
        remove() {
            this.emit("remove"), this.subscriptions.forEach((t => t())), this.element.remove(), this.element = null
        }
    }
    ...
    class o extends e {
        ...
        adjustScroll(t) {
            ...
            if (r <= s) return;
            const o = n.getBoundingClientRect(), a = t.element.getBoundingClientRect(), h = a.left - o.left,
                l = a.right - o.left;
        ...
        virtualAppend(t, e, i) {
            const n = () => {
                ...
                const n = this.wavesurfer.getWidth(), s = this.wavesurfer.getScroll(), r = e.clientWidth,
                    o = this.wavesurfer.getDuration(), a = Math.round(t.start / o * r),
                    h = a + (Math.round((t.end - t.start) / o * r) || 1) > s && a < s + n;
        ...
        addRegion(t) {
            ...
            const n = this.wavesurfer.getDuration(),
                ...
                o = new r(t, n, s);
            return this.emit("region-initialized", o), n ? this.saveRegion(o) : this.subscriptions.push(this.wavesurfer.once("ready", (t => {
        ...
        enableDragSelection(t, e = 3) {
            ...
            return i(s, ((t, e, i) => {
                ...
                const s = this.wavesurfer.getDuration(),
                    h = null === (n = null === (i = this.wavesurfer) || void 0 === i ? void 0 : i.getDecodedData()) || void 0 === n ? void 0 : n.numberOfChannels, {width: l} = this.wavesurfer.getWrapper().getBoundingClientRect(),
                    d = e / l * s, c = (e + 5) / l * s;
                o = new r(Object.assign(Object.assign({}, t), {
                    start: d,
                    end: c
                }), s, h), this.emit("region-initialized", o), this.regionsContainer.appendChild(o.element)
            }), (() => {
